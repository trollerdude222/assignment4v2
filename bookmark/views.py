...
def suggest_category(request):
        ...
        return render_to_response('bookmark/category_list.html', {'sw':starts_with,'cat_list': cat_list }, context)
...
def index(request):
    ...
    category_list = get_category_list(5)
    ...
    context_dict = {'categories': category_list , 'pages':page_list, 'cat_list': category_list}
...
def add_category(request):
    ...
    return render_to_response('bookmark/add_category.html', {'form': form, 'categories':get_category_list()}, context)
